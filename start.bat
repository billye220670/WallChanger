...
"C:\Users\Administrator\miniconda3\python.exe" -c "import uvicorn" >nul 2>&1
if %errorlevel% neq 0 (
...
start "WallChanger-Backend" cmd /k "cd /d %~dp0backend && C:\Users\Administrator\miniconda3\python.exe -m uvicorn main:app --host 0.0.0.0 --port 8100 --reload"
